...
class BlenderDriver(bpy.types.Operator):
    ...
    inputPath: bpy.props.StringProperty(name="inputPath", default=os.path.join(os.getcwd(), r"E:\Ben Fairlamb\inputs\Section_10.fbx"))
    outputPath: bpy.props.StringProperty(name="outputPath", default=os.path.join(os.getcwd(), r"E:\Ben Fairlamb\outputs\Section_10.gltf"))
    decRatio: bpy.props.FloatProperty(name="decRatio", default=0.0)
