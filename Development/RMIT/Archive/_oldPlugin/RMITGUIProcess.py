...
class Ui_MainWindow(QtWidgets.QWidget):
    ...
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.Process, 6, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.textBrowser2, 4, 0, 1, 1)
        spacerItem = QtWidgets.QSpacerItem(
            20, 40, QtWidgets.QSizePolicy.Minimum,
            QtWidgets.QSizePolicy.Expanding)
        self.gridLayout.addItem(spacerItem, 1, 2, 2, 2)
        ...
        self.gridLayout.addWidget(self.btnOutput, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.CleanUp_chkBox, 5, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.Headless_chkBox, 6, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.dec_slider, 1, 3, 5, 3)
        ...
        self.gridLayout.addWidget(self.slider_label, 3, 3, 1, 1)
        ...
        self.gridLayout.addWidget(
            self.processModel, 0, 0, 1, 2, QtCore.Qt.AlignHCenter)
    ...
    def processCollada(self):
        ...
        with open('dataProcessingLogs.txt', 'w') as f:
            try:
                ...
                scriptPath = cwdir.joinpath('driverStarter.py')
                isBlenderHere = list(
                    cwdir.parent.glob('**/blender-2.80/blender.exe'))
                ...
                p = subprocess.Popen(
                    ...
                    startupinfo=si, env=env, creationflags=subprocess.SW_HIDE)#
